export default {
  ...
  "--wsc-connectbutton-box-shadow": "inset 0 0 0 1px #E9EAEC, 0px 2px 4px rgba(0, 0, 0, 0.02)",
  ...
  "--wsc-primary-button-box-shadow": "0 0 0 1px #E9EAEC, 0px 2px 4px rgba(0, 0, 0, 0.02)",

  "--wsc-primary-button-hover-background": "#F6F7F9",
  "--wsc-primary-button-hover-box-shadow": "0 0 0 1px #D9DBDD, 0px 0 0 rgba(0, 0, 0, 0.02)",

  "--wsc-secondary-button-border-radius": "12px",
  "--wsc-secondary-button-color": "#414451",
  "--wsc-secondary-button-background": "#ffffff",
  "--wsc-secondary-button-box-shadow": "0 0 0 1px #E9EAEC, 0px 2px 4px rgba(0, 0, 0, 0.02)",

  "--wsc-secondary-button-hover-background": "#F6F7F9",
  "--wsc-secondary-button-hover-box-shadow": "0 0 0 1px #D9DBDD, 0px 0 0 rgba(0, 0, 0, 0.02)",
  ...
  "--wsc-dropdown-color": "rgba(55, 55, 55, 0.4)",
  ...
  "--wsc-qr-dot-color": "#2E3138",
  "--wsc-qr-border-color": "#E9EAEC",

  "--wsc-siwe-border": "#EAEBED",
};
